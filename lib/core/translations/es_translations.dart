...
final Map<String, String> esTranslations = {
  ...
  'config_complete': 'La configuración básica está completa.',
  'continue_config': 'Continuar con la configuración',
  'coming_soon': 'Próximamente',
  'coming_soon_message':
      'Esta función estará disponible en la siguiente sesión',
  'coming_soon_section': 'Esta sección estará disponible pronto',
  ...
  'create_child_profile': 'Crear perfil de hijo/a',
  ...
  'challenge_description': 'Descripción',
  'points': 'Puntos',
  'category': 'Categoría',
  ...
  //Errors
  'server_error_message': 'Error en el servidor. Inténtalo de nuevo más tarde.',
  ...
  'camera': 'Cámara',
  'retry': 'Reintentar',
  'no_profile_data': 'No hay datos de perfil disponibles',
  'error_selecting_image': 'Error al seleccionar la imagen',
  'error_capturing_image': 'Error al capturar la imagen',
  'error_uploading_image': 'Error al subir la imagen',
  'children': 'Hijos',
  'account_created': 'Cuenta creada',
  'family_created': 'Familia creada',
  ...
  // Biblioteca de retos
  'challenge_library': 'Biblioteca de Retos',
  'filter_challenges': 'Filtrar Retos',
  'search_challenges': 'Buscar retos',
  'import_challenges': 'Importar Retos',
  'export_challenges': 'Exportar Retos',
  ...
  'years': 'años',
  'age_appropriate': 'Apropiado para la Edad',
  'show_only_age_appropriate': 'Mostrar solo apropiados para la edad',
  'age_appropriate_explanation':
      'Solo retos recomendados para la edad seleccionada',
  'age_range_explanation': 'Retos cuyo rango de edad coincide con el filtro',
  'child_age': 'Edad del niño:',
  'reset_filters': 'Restablecer Filtros',
  'apply_filters': 'Aplicar Filtros',
  'clear_all_filters': 'Limpiar Filtros',
  'challenge_found': 'reto encontrado',
  'challenges_found': 'retos encontrados',
  'no_challenges_found': 'No se encontraron retos',
  'try_changing_filters': 'Intenta cambiar los filtros de búsqueda',
  'add_to_family': 'Añadir a mi Familia',
  'details': 'Detalles',
  'description': 'Descripción',
  'challenge_details': 'Detalles del Reto',
  'original_points': 'Puntos Originales',
  'adapted_points': 'Puntos Adaptados',
  'import': 'Importar',
  'export': 'Exportar',
  'import_to_family': 'Importar a mi Familia',
  'export_selected': 'Exportar Seleccionados',
  'import_selected_confirmation': '¿Deseas importar @count retos a tu familia?',
  'import_success': 'Importación Exitosa',
  'challenges_imported': '@count retos importados a tu familia',
  'export_success': 'Exportación Exitosa',
  'challenges_exported': '@count retos exportados',
  'export_filtered': 'Exportar Retos Filtrados',
  'export_all': 'Exportar Todos los Retos',
  'number_of_challenges': '@count retos',
  ...
  'select': 'Seleccionar',
  'import_instructions': 'Pega el código JSON de los retos a importar:',
  'paste_json_here': 'Pega el JSON aquí',
  'import_error_title': 'Error de Importación',
  'import_error_message': 'Ocurrió un error al importar los retos',
  'export_error_title': 'Error de Exportación',
  'export_error_message': 'Ocurrió un error al exportar los retos',

  // Categorías de retos
  'category_hygiene': 'Higiene',
  'category_school': 'Escuela',
  'category_order': 'Orden',
  'category_responsibility': 'Responsabilidad',
  'category_help': 'Ayuda',
  'category_special': 'Especial',
  'category_sibling': 'Hermanos',
  ...
  'cloud_data_source': 'Datos desde la nube',
  'local_data_source': 'Datos locales',
  'loading_data_source': 'Cargando origen de datos',
  'sync_with_cloud': 'Sincronizar con la nube',
  'cloud_sync': 'Sincronización en la nube',
  'cloud_sync_info':
      'Los retos se están sincronizando desde la nube. Esto permite acceder a las últimas actualizaciones y retos nuevos sin necesidad de actualizar la aplicación.',
  'cloud_sync_active': 'Sincronización activa',
  'sync_in_progress': 'Sincronización en progreso',
  'sync_success': 'Sincronización completada',
  'sync_failed': 'Error en la sincronización',
  'template_saved_title': 'Plantilla guardada',
  'template_saved_message': 'La plantilla de reto se ha guardado en la nube',
